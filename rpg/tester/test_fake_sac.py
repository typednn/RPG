...
trainer = SAC.parse(env, update_step=1000, buffer=dict(priority=False), head=dict(std_scale=1.), qnet=dict(predict_q=True, gamma=0.99), action_penalty=0.0, entropy_target=-6)
