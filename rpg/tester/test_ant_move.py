...
trainer = SkillLearning.parse(
    ...
    _variants=dict(
        ...
        norew2=dict(z_dim=0, z_cont_dim=12, info=dict(mutual_info_weight=1., action_weight=0.), ir=dict(reward_decay=dict(init_value=0.02)), wandb=dict(name='antmove'), enta=dict(coef=1., target=2.)),
    )
