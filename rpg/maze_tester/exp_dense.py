...
if __name__ == '__main__':
    ...
    for env_name  in ['cabinet', 'ant', 'fall']: # ensure the experiments are finished ..
        ...
        exp.add_exps(
            f'dense{env_name}',
            dict(
                env_cfg=dict(n=[5] * 9 + [1], reward_type='dense', obs_dim=0),
                _base=[
                ...
                reward_schedule=["1000000" if env_name == 'ant' else "800000"] * 8 + [
                    '2seg(0.25,240000,500000)', schedule],
            ),
            names=[
                'sac', 'discrete5', 'discrete10', 'discrete50', 'discrete100',
                'discrete500', 'gaussian10', 'incrR', 'seg', 'incrRn1'], # note that seg is seg2 before
            base='mbsacv3', 
