    ...
    for env_name  in ['cabinet', 'ant']: # ensure the experiments are finished ..
        exp.add_exps(
            ...
            dict(
                ...
                _base=['mbsacv3', 'rpgdv3', 'rpgdv3', 'rpgdv3', 'rpgdv3', 'rpgdv3', 'rpgcv2', 'rewardrpg'],
                info=dict(coef=[0.0, 0.5, 1., 5., 10., 50., 1., 10.]),
                rnd=dict(scale=0.),
                z_delay=4,
            ...
            names=['sac', 'discrete5', 'discrete10', 'discrete50', 'discrete100', 'discrete500', 'gaussian10', 'incrR'],
            base='mbsacv3', 
