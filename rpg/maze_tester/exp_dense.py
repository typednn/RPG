    ...
    for env_name  in ['cabinet', 'ant']: # ensure the experiments are finished ..
        exp.add_exps(
            ...
            dict(
                ...
                _base=['mbsacv3', 'rpgdv3', 'rpgdv3', 'rpgdv3', 'rpgdv3', 'rpgdv3', 'rpgcv2'],
                info=dict(coef=[0.0, 0.5, 1., 5., 10., 50., 1.]),
                rnd=dict(scale=0.),
                z_delay=4,
                pi_a=dict(ent=dict(coef=1.)),
                pi_z=dict(ent=dict(coef=100.)),
            ),
            names=['sac', 'discrete5', 'discrete10', 'discrete50', 'discrete100', 'discrete500', 'gaussian10'],
            base='mbsacv3', 
