...
quality = 2
from llm.envs import soft_utils
...
state = state.switch_tools('Gripper', np.array([0.65, 0.3, 0.5, 0., 0.1]), friction=0., size=(0.02, 0.2, 0.2), action_scale=(0.015, 0.015, 0.015, 0.015, 0.015), softness=0.)
images = []
env.set_state(state)

for i in tqdm.trange(100):
    env.step([0, -0.4, 0., 0., 0.2 if i > 25 else 0.])
